...
Dalším příkladem asociativního pole je _map_key_value. Umožňuje nám najít podle názvu klávesy koeficienty pro pohyb po jednotlivých osách._
...
Maximální počet hráčů a jméno místnosti zadává uživatel do formuláře na domovské stránce. Session_id pocházi ze socketio. _tank_ je instance třídy _Tank_.
...
_index_ tanku - získáme voláním tanks_length() na instanci _Room_, do které daný tank patří.
